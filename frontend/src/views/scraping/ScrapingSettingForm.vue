    ...
    <VRow>
      <VCol cols="12">
        <VRow no-gutters>
          ...
          <VCol cols="12" md="9">
            <VTextField id="Name" v-model="currentSetting.name" />
          </VCol>
        </VRow>
      </VCol>
      ...
      <VCol cols="12">
        <VRow no-gutters>
          ...
          <VCol cols="12" md="9">
            <VTextField id="description" v-model="currentSetting.description" />
          </VCol>
        </VRow>
      </VCol>
      ...
      <VCol cols="12">
        <VRow no-gutters>
          ...
          <VCol cols="12" md="9">
            <VTextField id="naming_rule" v-model="currentSetting.naming_rule" />
          </VCol>
        </VRow>
      </VCol>
