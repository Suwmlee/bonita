export default {
  ...
  pages: {
    ...
    metadata: {
      ...
      update: 'Update',
      cover: 'Cover',
      noResults: 'No metadata found. Try adjusting your search or add new metadata.',
    ...
    serviceSettings: {
      ...
      proxy: {
        ...
        subtitle: 'The proxy configured here will be used for application network requests',
        http: 'HTTP Proxy',
        https: 'HTTPS Proxy',
  ...
  components: {
    metadata: {
      ...
      form: {
        ...
        uploadSuccess: 'Image uploaded successfully, but could not determine path. Check the console for details.',
        save: 'Save',
        cancel: 'Cancel',
      }
    },
    ...
    task: {
      ...
      form: {
        ...
        scrapingHint: 'If you cannot find the desired configuration here, please add it in "Scraping" section',
        enabled: 'Enabled',
